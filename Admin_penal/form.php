...
<head>
    ...
    <title>Insert Appointment Request</title>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO appointment_requests (username, service_type, request_time, phoneno, address) VALUES ('$username', '$service_type', '$request_time', '$phoneno', '$address')";

    if (mysqli_query($conn, $sql)) {
        echo "<div class='alert alert-success text-center'>Appointment request submitted successfully!</div>";
    } else {
