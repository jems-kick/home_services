...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($row && password_verify($password, $row['password'])) {
        ...
        header("Location: http://" . $_SERVER['HTTP_HOST'] . "\Home Servises\frontend\index.html"); // Absolute path
...
<div class="login-container">
    ...
    <p class="footer">Don't have an account? <a href="user_signup.php">Register here</a></p>
</div>
